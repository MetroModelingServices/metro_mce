...
write.table(ma.hbsprl, sep=",", row.names=F, file="ma.hbsprl.csv", col.names=c("hbsprl"))
...
write.table(ma.hbsprm, sep=",", row.names=F, file="ma.hbsprm.csv", col.names=c("hbsprm"))
...
write.table(ma.hbsprh, sep=",", row.names=F, file="ma.hbsprh.csv", col.names=c("hbsprh"))
